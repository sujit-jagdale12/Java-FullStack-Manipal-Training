...
public class SpringOrmMappingApplication {

	public static void demo(PersonRepository repository) {
	...
	public static void demo3(PersonService personService) {
		personService.addContactDetails(1, "55555555", "jacksprrow@34.com");
		personService.addContactDetails(1, "11111111", "jacksprrow@37.com");
		personService.addContactDetails(1, "22222222", "jacks@37.com");
	}

	

	public static void main(String[] args) {
		ApplicationContext ctx= SpringApplication.run(SpringOrmMappingApplication.class, args);
